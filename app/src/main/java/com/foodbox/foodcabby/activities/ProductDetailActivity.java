...
import com.foodbox.foodcabby.adapter.AddOnsAdapter;
import com.foodbox.foodcabby.adapter.SliderPagerAdapter;
            ...
            public void onClick(View view) {
                if (GlobalData.profileModel == null)
                    ...
                    if (product.getCart() != null && product.getCart().size() == 1 && product.getAddons().isEmpty()) {
                        ...
                        map.put("quantity", "1");
                        if (!AddOnsAdapter.list.isEmpty()) for (int i = 0; i < AddOnsAdapter.list.size(); i++) {
                            Addon addon = AddOnsAdapter.list.get(i);
