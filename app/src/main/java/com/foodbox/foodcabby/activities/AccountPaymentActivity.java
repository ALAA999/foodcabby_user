...
import com.foodbox.foodcabby.adapter.AccountPaymentAdapter;
import com.foodbox.foodcabby.build.api.ApiClient;
import com.foodbox.foodcabby.build.api.ApiInterface;
import com.foodbox.foodcabby.fragments.CartFragment;
...
import static com.foodbox.foodcabby.helper.GlobalData.cardArrayList;
import static com.foodbox.foodcabby.helper.GlobalData.currencySymbol;
import static com.foodbox.foodcabby.helper.GlobalData.isCardChecked;
...
//import com.foodbox.app.braintree.CreateTransactionActivity;
//import com.foodbox.app.braintree.Settings;
...
//        findViewById(R.id.btKlarna).setOnClickListener(new View.OnClickListener() {
//            @Override
...
//                paymentView.registerPaymentViewCallback(new KlarnaPaymentViewCallback() {
//                    @Override
...
//
//                    @Override
//                    public void onAuthorized(@NotNull KlarnaPaymentView klarnaPaymentView, boolean b, @Nullable String s, @Nullable Boolean aBoolean) {
//
//                    }
//
//                    @Override
//                    public void onReauthorized(@NotNull KlarnaPaymentView klarnaPaymentView, boolean b, @Nullable String s) {
//
//                    }
//
//                    @Override
//                    public void onFinalized(@NotNull KlarnaPaymentView klarnaPaymentView, boolean b, @Nullable String s) {
//
//                    }
//
//                    @Override
...
//                        Log.e("asdasd", klarnaPaymentsSDKError.getMessage());
//                    }
//                });
//                Log.e("token" , SharedHelper.getKey(getApplicationContext(), "access_token"));
//                paymentView.initialize(SharedHelper.getKey(getApplicationContext(), "access_token"), "com.foodbox.app");
