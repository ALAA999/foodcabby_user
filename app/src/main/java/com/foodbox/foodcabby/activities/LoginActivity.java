...
import com.foodbox.foodcabby.CountryPicker.Country;
import com.foodbox.foodcabby.CountryPicker.CountryPicker;
import com.foodbox.foodcabby.CountryPicker.CountryPickerListener;
...
import com.foodbox.foodcabby.build.configure.BuildConfigure;
...
import com.foodbox.foodcabby.models.AddressList;
...
//                Snackbar.make(this.findViewById(android.R.id.content), getResources().getString(R.string.coming_soon), Snackbar.LENGTH_SHORT).show();
    ...
    private void getUserCountryInfo() {
        ...
        if (country != null) {
            Country us =  new Country("DE", "Germany", "+49", R.drawable.flag_de);
    ...
    private boolean isValidMobile(String phone) {
        return !(phone == null || phone.length() < 6 || phone.length() > 15) && android.util.Patterns.PHONE.matcher(phone).matches();
    }
