...
import com.foodbox.foodcabby.fragments.AddonBottomSheetFragment;
import com.foodbox.foodcabby.fragments.CartChoiceModeFragment;
...
import com.foodbox.foodcabby.models.CartAddon;
import com.foodbox.foodcabby.models.Product;
...
import static com.foodbox.foodcabby.fragments.CartFragment.minimum_amount;
import static com.foodbox.foodcabby.fragments.CartFragment.minimum_amount_layout;
            ...
            public void onResponse(Call<AddCart> call, Response<AddCart> response) {
                ...
                if (response != null && !response.isSuccessful() && response.errorBody() != null)
                    ...
                    if (itemCount != 0) {
                        ...
                        Log.e(getClass().getName() + "priceAmount7", "" + priceAmount);
        ...
        holder.cardMinusBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (holder.cardTextValue.getText().toString().equalsIgnoreCase("1")) {
                    ...
                    quantity = Integer.parseInt(holder.cardTextValue.getText().toString());
                    priceAmount = quantity * product.getPrices().getPrice();
                    if (list.get(position).getCartAddons() != null && !list.get(position).getCartAddons().isEmpty())
                        for (int j = 0; j < list.get(position).getCartAddons().size(); j++)
                            priceAmount = priceAmount + (list.get(position).getQuantity()
