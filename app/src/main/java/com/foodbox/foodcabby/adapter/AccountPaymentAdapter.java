...
import com.foodbox.foodcabby.activities.AddMoneyActivity;
            ...
            public void onClick(View view) {
                if (!isDeleteAvailable && holder.paymentLabel.isChecked()) {
                    for (int i = 0; i < GlobalData.cardArrayList.size(); i++) {
                        if (GlobalData.cardArrayList.get(i).getCardId().equals(obj.getCardId()))
                            GlobalData.cardArrayList.get(i).setChecked(true);
                        else
